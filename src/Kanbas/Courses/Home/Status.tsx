...
import { AiOutlineHome, AiOutlineEye, AiOutlineNotification } from "react-icons/ai"; // Home page, view icons
import { BsMegaphone, BsBarChart } from "react-icons/bs"; // Announcement, Analytics icons
