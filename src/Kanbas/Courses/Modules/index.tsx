...
import { BsGripVertical } from "react-icons/bs"; // 引入图标
import ModuleControlButtons from "./ModuleControlButtons"; // 引入控制按钮组件
import LessonControlButtons from "./LessonControlButtons"; // 引入控制按钮组件
